    ...
    <div className="flex flex-col gap-8">
      <div className="bg-[#161b22] p-4">
        ...
        <p className="text-gray-300 mt-2 text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, interdum
          enim orci sociis aliquet. Scelerisque nulla integer egestas arcu.
          Vitae nisi magna imperdiet sed. Sit metus, gravida a vel, purus. Eget
          ligula cursus facilisi neque sed.
        </p>
      </div>
      ...
      <div className="bg-[#161b22] p-4">
        <h3 className="text-lg font-semibold mb-2">
          Attended 30% of sessions and events in 2021
        </h3>
        ...
        <p className="text-xs text-gray-400 mt-1">
          Hover to see the event or session
        </p>
      </div>
