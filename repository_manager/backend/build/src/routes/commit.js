...
commitRouter.post('/create/finalze', async (req, res) => {
    try {
        ...
        const { message, paramHash, params, architecture, initiateToken, // NEW: from /create/initiate
        ...
        const sessionId = sessionJwt.sessionId;
        ...
        let zkmlProofCreateObj = undefined;
