...
sharedFolderRouter.put('/files/keras/:committerAddress/:key', raw({ type: 'application/octet-stream', limit: '50mb' }), sharedFolderController.uploadKerasMetrics);
// The pickled model is stored in this route
sharedFolderRouter.put('/files/:committerAddress', raw({ type: 'application/octet-stream', limit: '50mb' }), sharedFolderController.uploadModel);
// Binary file routes
