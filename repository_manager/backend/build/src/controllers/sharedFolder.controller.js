...
export async function pullSharedFolder(req, res) {
    const { branchId } = req;
    const pk = authorizedPk(res);
    if (!branchId) {
        res.status(400).send({ error: { message: "Branch ID is required." } });
...
export async function uploadKerasMetrics(req, res) {
    try {
        const { branchId } = req;
        const pk = authorizedPk(res);
...
export async function getKerasFile(req, res) {
    const { branchId } = req;
    const pk = authorizedPk(res);
    const { committerAddress, key } = req.params;
    try {
...
export async function listKerasFiles(req, res) {
    const { branchId } = req;
    const pk = authorizedPk(res);
    const { committerAddress } = req.params;
    try {
...
export async function getModelFile(req, res) {
    const { branchId } = req;
    const pk = authorizedPk(res);
    const { committerAddress } = req.params;
    if (!committerAddress) {
...
// Delete routes here
export async function deleteKerasFile(req, res) {
    const { branchId } = req;
    const pk = authorizedPk(res);
    const { committerAddress, key } = req.params;
    if (!branchId) {
